...
$("button[name=btnPesquisar]").click(function(){     
    if($("select[name=txtTipoRela]").val() == '0'){
        ...
        if($("select[name=txtPGradRela]").val() == '0'){
            ...
            var idPostoGraduacao = $("select[name=txtPGradRela]").val();
            var nomeguerra = $("input[name=txtNomeGuerraRela]").val();
            getPlanoChamadaByMilitar(idPostoGraduacao, nomeguerra);
        }
    }
        ...
        if($("select[name=txtByPGradRela]").val() == '0'){
            ...
            var pgrad = $("select[name=txtByPGradRela]").val();
            getMilitaresByPGrad(pgrad);
        }
    }
        ...
        if($("select[name=txtDivSecRela]").val() == '0'){
            ...
            var divsec = $("select[name=txtDivSecRela]").val();
            getMilitaresByDivSec(divsec);
        }
    }
        ...
        if($("select[name=txtCiaRela]").val() == '0'){
            ...
            var cia = $("select[name=txtCiaRela]").val();
            getMilitaresByCia(cia);
        }
    }
